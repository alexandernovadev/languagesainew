  ...
  return (
    <Tabs defaultValue="info" className="w-full h-full flex flex-col">
      <TabsList className="flex-shrink-0 grid w-full grid-cols-2 shadow-md bg-transparent border-b">
        ...
        <TabsTrigger value="chat" className="flex items-center gap-2 data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none">
