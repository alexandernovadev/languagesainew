...
export default function LectureImportForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await api.post("/api/lectures/import-file", formData, {
        headers: {
          ...getAuthHeaders(),
      ...
      toast.success("Import successful", {
        ...
        action: {
          ...
          onClick: () => handleApiResult({ success: true, data, message: data.message || "Lectures imported successfully" }, "Importar Lecturas")
        }
      });
    } catch (error: any) {
