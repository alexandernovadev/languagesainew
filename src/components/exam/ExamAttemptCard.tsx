...
import { Clock, CheckCircle, XCircle, AlertCircle, Play, Trophy } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {attempt.submittedAt && (
            <div>
              ...
              <p className="font-medium">{formatDateShort(attempt.submittedAt)}</p>
            </div>
          )}
          {attempt.gradedAt && (
            <div>
