...
export const getQuestionTypeColor = (type: string): string => {
  const colors: Record<string, string> = {
    multiple_choice: 'bg-blue-500/20 text-blue-600 dark:text-blue-400 hover:ring-2 hover:ring-blue-400/50 hover:bg-blue-500/30',
    fill_blank: 'bg-green-500/20 text-green-600 dark:text-green-400 hover:ring-2 hover:ring-green-400/50 hover:bg-green-500/30',
    true_false: 'bg-fuchsia-500/20 text-fuchsia-600 dark:text-fuchsia-400 hover:ring-2 hover:ring-fuchsia-400/50 hover:bg-fuchsia-500/30',
    translate: 'bg-purple-500/20 text-purple-600 dark:text-purple-400 hover:ring-2 hover:ring-purple-400/50 hover:bg-purple-500/30',
    writing: 'bg-orange-500/20 text-orange-600 dark:text-orange-400 hover:ring-2 hover:ring-orange-400/50 hover:bg-orange-500/30'
  };
  return colors[type] || 'bg-muted text-muted-foreground hover:ring-2 hover:ring-gray-400/50 hover:bg-muted/40';
};
...
// Validation Helpers
export const validateExamFilters = (filters: any): { isValid: boolean; errors: string[] } => {
  const errors: string[] = [];
